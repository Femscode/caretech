...
output.severalImpact.hospitalBedsByRequestedTime =  input.totalHospitalBeds - output.severalImpact.hospitalBedsRequired
//challenge 3
...
output.severalImpact.dollarsInFlight = Math.floor((output.severalImpact.infectionByRequestedTime * input.region.avgDailyIncomePopulation * input.region.avgDailyIncomeInUSD)/ input.timetoElapse)
document.getElementById('show').style.visibility = 'visible';
document.getElementById('show').innerHTML = "<h2>The Result of the Estimate of the covid-19 infection   </h2>"+"<br>"+
